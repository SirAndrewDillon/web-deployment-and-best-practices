$(document).ready(function() {
	...
	let questions = [
		'I like dressing up in the opposite sex clothing.',
		'Harry Potter movies are for people that have never been laid.',
		'I have a poor grip on reality.',
		'Football is the best of all sports to support .',
		'Fatties are fat because they have no will power.',
		'I eat because I am lonely.',
		'Doughnuts are for more thn just eating.',
		'Capitalism is morally bankrupting our country .',
		'Your appearance can determine how your life turns out',
		'I believe in supreme being that lives in the clouds.'
	]
